...
class EnvTrafficLightTemplate(BaseEnv):
    ...
    def make_decisions(self):
        ...
        control_command_dict['veh'] = {
            veh_id: command_and_info[0] for veh_id, command_and_info in control_command_and_info['veh'].items()
        }
        control_command_dict['tls'] = {
            tls_id: command_and_info[0] for tls_id, command_and_info in control_command_and_info['tls'].items()
        }
        info_dict = dict()
        info_dict['veh'] = {
            veh_id: command_and_info[1] for veh_id, command_and_info in control_command_and_info['veh'].items()
        }
        info_dict['tls'] = {
            tls_id: command_and_info[1] for tls_id, command_and_info in control_command_and_info['tls'].items()
        }
