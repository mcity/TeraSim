...
from terasim_vis import Net as _Net
...
class _Poly:
    def __init__(self, attrib):
        ...
        self.color = Utils.convert_sumo_color(attrib["color"])
    ...
    def get_as_3d_object(self, z=0, extrude_height=0, include_bottom_face=False, material_param=None,
        ...
        return Utils.Object3D.from_shape(self.shape, self.id, material, z=z, extrude_height=extrude_height,
    ...
    def plot(self, ax, **kwargs):
        ...
        if self.fill is True:
            ...
            line = Utils.LineDataUnits(x, y, linewidth=self.lineWidth, **kwargs)
...
class _POI:
    def __init__(self, attrib, reference_net=None):
        ...
        :type attrib: dict
        :type reference_net: terasim_vis.Net
        """
        self.id = attrib["id"]
        self.color = Utils.convert_sumo_color(attrib["color"])
...
class _BusStop:
    ...
    def get_as_3d_objects(self, area_kwargs=None, markings_kwargs=None, **kwargs):
        ...
        outline = self._get_shape()
        if outline is not None:
            objs.append(Utils.Object3D.from_shape(outline, "busstop_area", "busstop_area", **area_kwargs))
        for marking in self._get_markings():
...
class Additionals:
    ...
    def generate_bus_stops_obj_text(self, area_kwargs=None, markings_kwargs=None, **kwargs):
        ...
        return Utils.generate_obj_text_from_objects(objs)
