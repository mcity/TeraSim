...
@click.command()
@click.option("--text_file", type=str, default=str(Path(__file__).parent / "assets/waymo_multiview_texts.json"), help="Path to JSON file containing text descriptions")
